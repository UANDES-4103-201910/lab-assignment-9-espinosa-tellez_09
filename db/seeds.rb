...
user_3 = User.create(name: 'Maximiliano', last_name: 'Garcia', email: 'mrgarcia1@miuandes.cl', phone: '987654321', password: 'password123', address: 'San Carlos de Apoquindo 2200', admin: 1)
...
event_1 = Event.create(name: 'ICPC 2018', start_date: DateTime.new(2019, 05, 25), place: place_1)
